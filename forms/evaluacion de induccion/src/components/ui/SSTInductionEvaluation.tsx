...
export default function SSTInductionEvaluation() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Prepare data for the administrator
    const adminData = {
      id: formData.id,
      name: formData.name,
      formName: "EVALUACION INDUCCION SST",
      openEndedResponses: [
        ...Object.entries(formData.q3).map(([key, value]) => ({
          question: `3${key}) Enumere cuatro (4) controles que usted debe seguir para prevenir un accidente y una enfermedad de trabajo.`,
          answer: value,
        })),
        ...Object.entries(formData.q5).map(([key, value]) => ({
          question: `5${key}) Indique que hacer en caso de presentarse un AT y cual es la entidad que lo atiende:`,
          answer: value,
        })),
      ],
    }
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-100 p-4 rounded-md border-l-4 border-orange-500">
                <p className="font-bold">
                  3. Enumere cuatro (4) controles que usted debe seguir para prevenir un accidente y una enfermedad de
                  trabajo.
                </p>
                <div className="space-y-2 mt-2">
                  {["a", "b", "c", "d"].map((option) => (
              ...
              <div className="bg-gray-100 p-4 rounded-md border-l-4 border-orange-500">
                <p className="font-bold">
                  4. Señale los elementos de protección personal que deberá usar durante la realización de su labor o
                  cuando visito un proyecto:
                </p>
                <div className="space-y-2 mt-2">
          ...
          {isSubmitted && (
            <div className="mt-4 p-4 bg-green-500 text-white text-center rounded-md font-bold">EVALUACIÓN ENVIADA</div>
          )}
        </CardContent>
      </Card>
    </div>
